...
public class ListsTests : BaseRadioBrowserClientTest
{
    ...
    private async Task GetAll<T>(Func<string, ExtendedQueryOptions, Task<T[]>> funcTask)
    {
    ...
    private async Task GetByFilters<T>(Func<string, ExtendedQueryOptions, Task<T[]>> funcTask)
    {
