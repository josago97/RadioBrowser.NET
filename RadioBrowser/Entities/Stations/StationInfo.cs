...
using RadioBrowser.Utilities.JsonConverters;
using DateTimeConverter = RadioBrowser.Utilities.JsonConverters.DateTimeConverter;
...
namespace RadioBrowser
{
    public class StationInfo
    {
        ...
        /// <summary>
        /// True means no error, False means that there was an ssl error while connecting to the stream url.
        /// </summary>
